...
- [Bible School LMS](https://github.com/ArVaViT/biblie-school) - Open-source LMS for Bible schools with a TipTap-powered rich content editor (images, YouTube embeds, callouts, audio blocks). by [@ArVaViT](https://github.com/ArVaViT)
